							...
							<div class="search-bar-top">
								<div class="search-bar">
									<select id = "catsearch">
										...
										<input name="searchproduct" id = "searchproduct" placeholder="Search Products Here....." type="search">
										<!--<button id = "searcher" class="btnn"><i class="ti-search"></i></button>-->
