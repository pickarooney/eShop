<!DOCTYPE html>
 ...
 <?php  
	...
	$ccode = ''; $fname = '';$lname='';$email='';$mobile='';
	//$serverName = '(local)';
			 ...
			 <form action="eShop.php" method="POST">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="container" id="recapintro">
						<p>Some introductory text recapping the order</p>
						</div>
						<div class="container" id="recapheader">
						  <div class="row" style="font-weight:bold;align-items-center;height:50px; padding-top:20px">
							...
							$displayHTML = displayRecap($serverName,$productList,'');	
							echo $displayHTML;							

							?>
						
						
						<div class="container" id="recapdetails">
						</div>
					</div>
				</div>			
			 </form>
